        ...
        <div class="panel panel-default comment-data" style="padding: 10px;">
            ...
            <div class="panel-body">
                ...
                <div class="pull-right">
                    ...
                    <a href="#marcoModal{{ $comment->id }}" role="button" class="btn btn-sm btn-danger"
                        data-toggle="modal">Eliminar Comentarios</a>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a href="{{ url('delete-comment/'.$comment->id) }}" type="button"
